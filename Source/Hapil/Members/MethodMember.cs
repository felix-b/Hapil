...
namespace Hapil.Members
{
	public class MethodMember : MemberBase
	{
	    ...
	    public bool HasInvokableBaseMethod
	    {
	        get
	        {
	            return (m_MethodFactory.InvokableBaseMethod != null);
	        }
	    }
        ...
        public MethodBuilder MethodBuilder
        {
            get
            {
                return (m_MethodFactory.Builder as MethodBuilder);
            }
        }
        ...
        public ConstructorBuilder ConstructorBuilder
        {
            get
            {
                return (m_MethodFactory.Builder as ConstructorBuilder);
            }
        }
